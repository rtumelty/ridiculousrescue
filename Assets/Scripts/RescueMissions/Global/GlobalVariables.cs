...
{	
	...
	public static bool READY_FOR_NEXT_TURN = true;
	public static bool NO_LIFE_RESTART = false;
	public static bool RESTRICT_MADRA_TUTORIAL_LEVEL_3 = false;
	//*************************************************************//	
	...
	public static bool OPENING_SEQUENCE = false;
	public static bool MENU_FOR_RESOULT_SCREEN = false;
	public static GameObject lastOne;
	//*************************************************************//	
	public static bool checkForMenus ()
	{
		return ( MENU_FOR_RESOULT_SCREEN || OPENING_SEQUENCE || TRANSACTION || CHARACTER_PASSING_ANIMATION || POPUP_UI_SCREEN || MENU_FOR_REDIRECTOR || CHARACTER_IN_MOVE || CHARACTER_CELEBRATING || SCREEN_DRAGGING || MENU_FOR_TIP || UI_CLICKED || LOADING_SAVING_MENU || TUTORIAL_MENU || TOY_LAZARUS_SEQUENCE || START_SEQUENCE || CHARACTER_BOX );
	}
	//*************************************************************//
