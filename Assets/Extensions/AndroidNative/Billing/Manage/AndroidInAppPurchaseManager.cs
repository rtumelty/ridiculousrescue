...
public class AndroidInAppPurchaseManager : SA_Singleton<AndroidInAppPurchaseManager> {
	...
	public void OnPurchaseFinishedCallback(string data) {
		...
		//ConsoleManager.getInstance ().addToExternalString  ("purchase finished");
		string[] storeData;
		...
		AddGoldButton.OnProductPurchased (result);
	}


	public void OnConsumeFinishedCallBack(string data) {
		Debug.Log("consume finished");
		//ConsoleManager.getInstance ().addToExternalString  ("consume finished");
		string[] storeData;
		storeData = data.Split(AndroidNative.DATA_SPLITTER [0]);
		...
		AddGoldButton.OnProductConsumed (result);
	}



	public void OnBillingSetupFinishedCallback(string data) {
		Debug.Log ("billing setup finished");
		//ConsoleManager.getInstance ().addToExternalString  ("billing setup finished");
		string[] storeData;
		storeData = data.Split(AndroidNative.DATA_SPLITTER [0]);
		...
		AddGoldButton.OnBillingConnected (result);
	}


	public void OnQueryInventoryFinishedCallBack(string data) {
		Debug.Log("query inventory finished");
		//ConsoleManager.getInstance ().addToExternalString  ("query inventory finished");
		string[] storeData;
		storeData = data.Split(AndroidNative.DATA_SPLITTER [0]);
		...
		AddGoldButton.OnRetriveProductsFinised (result);
	}
